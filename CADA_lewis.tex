...
Why does language structure reflect the patterns that appear in language use? In the present section, I propose a speculative answer to this question. The answer  posits a causal link between pragmatics and linguistic structure. Critically, the answer relies on an analysis of language separated by timescales. The hypothesis is that the reason structure reflects pragmatics is the result of local dynamics between adjacent timescales.

4 useful timescales

Here are the timscales - diagram - in what follows, consider dynamics between adjacent timscales \cite{mcmurray}
